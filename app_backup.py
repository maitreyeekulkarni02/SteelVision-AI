...
from utils.history import get_history, save_inspection
...
from utils.analytics import (calculate_defect_severity,
                             generate_inspection_summary, get_confidence_data)
from utils.dashboard import (display_edge_status, display_machine_metrics,
                             display_status_panel)
from utils.defect_engine import generate_industrial_defects
from utils.history import format_history, get_history, save_inspection
from utils.inspection import (calculate_health_score, get_machine_status,
                              get_priority, get_recommendation)
